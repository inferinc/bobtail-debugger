...
module.exports = function (grunt) {
  ...
  grunt.initConfig({
    ...
    copy: {
      maps: {
        src: '.tmp/reactive-coffee-debugger.js.map',
        dest: 'dist/reactive-coffee-debugger.js.map'
      }
    },
    uglify: {
      dist: {
        options: {
          sourceMap: true,
          sourceMapIn: 'dist/reactive-coffee-debugger.js.map',
          sourceMapName: 'dist/reactive-coffee-debugger.min.js.map'
        },
        files: {
